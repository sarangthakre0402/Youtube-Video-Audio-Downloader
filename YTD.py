...
root = Tk()
root.title("Sarang's Downloader")
root.geometry("500x700") #set window
root.columnconfigure(0,weight=1)#set all content in center.

#Ytd Link Label
ytdLabel = Label(root,text="Enter the URL of the Youtube Video",font=("jost",15))
ytdLabel.grid()
...
#developer Label
developerlabel = Label(root,text="Sarang Thakre",font=("jost",15))
developerlabel.grid()
root.mainloop()